...
export class OrdersController {
  ...
  async getBuyOrderPayload(
    ...
    const data = await globalThis.page.evaluate(
      async (chain: string, tokenID: string, assetContractAddress: string) => {
        ...
        xhr.setRequestHeader(
          "authorization",
          "JWT eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..i0auLQGlWZm7f1gXcLsrtzUAgv9WiO3ev5rdOr0wzAc"
        );
        ...
        xhr.setRequestHeader(
          "x-viewer-address",
          "0x00000e8c78e461678e455b1f6878bb0ce50ce587"
        );
    ...
    const makeOffer = await globalThis.page.evaluate(
      async (chain: string, relayID: string, assetContractAddress: string) => {
        var data = JSON.stringify({
    ...
    const response = await globalThis.page.evaluate(async (orderID: string) => {
      var data = JSON.stringify({
