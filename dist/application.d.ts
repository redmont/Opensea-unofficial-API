...
declare const ApiBlurUnofficialApplication_base: (new (...args: any[]) => {
    projectRoot: string;
...
export declare class ApiBlurUnofficialApplication extends ApiBlurUnofficialApplication_base {
